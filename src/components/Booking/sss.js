  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    if (
      ...
      options.template =
        ...
        '</div>' +
        '</div>';
    alert(JSON.stringify(options) + 'oo----o');
    this.parentEl =
    ...
    alert('pwefwfnw45676fc6' + typeof options.isInvalidDate + '---');
    console.log(JSON.stringify(options));
    console.log(JSON.stringify(options.isInvalidDate));
    alert('something' + JSON.stringify(options));
